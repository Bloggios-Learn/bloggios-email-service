...
@Component
public class RegisterOtpToMailHistoryTransformer implements Transform<MailHistoryEntity, RegisterOtpMailRequest> {
    ...
    @Override
    public MailHistoryEntity transform(RegisterOtpMailRequest request) {
